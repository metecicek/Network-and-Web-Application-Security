# -*- coding: utf-8 -*-
"""
Created on Sat Feb 27 00:02:52 2021
...
def menu():
	while True:
		try:
			...
			print('---------------------')
			print('')
			print('1: Provide Local Machine Host Name')
			print('2: Provide Local Machine IP Address')
			print('3: Provide Remote Machine IP Address')
			print('4: Provide Service Running On A Port')
			print('5: Provide Machine Open Ports')
			print('6: Quit')
